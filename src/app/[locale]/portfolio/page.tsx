...
export default async function PortfolioPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  // Aktif portföy çalışmalarını translations ile çekelim
  ...
  // Verileri formatlayıp temiz JSON olarak client'a geçelim
  ...
  // Benzersiz kategorileri listele (Filtreleme sekmeleri için)
    ...
    <main className="min-h-screen pt-32 pb-24 relative overflow-hidden bg-[#faf8f7]">
      ...
      <div className="max-w-6xl mx-auto px-6 z-10">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-serif italic font-bold text-gray-950 mb-4">Güzellik Değişimleri</h1>

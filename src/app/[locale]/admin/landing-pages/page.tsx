...
export default async function AdminLandingPagesPage({ params }: { params: Promise<{ locale: string }> }) {
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <LandingPagesClient initialPages={formattedPages} currentLocale={locale} />
          </div>
        </main>
      </div>
    </div>
